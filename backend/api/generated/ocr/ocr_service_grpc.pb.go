...
type OCRServiceClient interface {
	ProcessPDF(ctx context.Context, in *PDFRequest, opts ...grpc.CallOption) (*StringListResponse, error)
}
...
func (c *oCRServiceClient) ProcessPDF(ctx context.Context, in *PDFRequest, opts ...grpc.CallOption) (*StringListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StringListResponse)
	err := c.cc.Invoke(ctx, OCRService_ProcessPDF_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OCRServiceServer interface {
	ProcessPDF(context.Context, *PDFRequest) (*StringListResponse, error)
...
func (UnimplementedOCRServiceServer) ProcessPDF(context.Context, *PDFRequest) (*StringListResponse, error) {
...
func _OCRService_ProcessPDF_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OCRService_ProcessPDF_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OCRServiceServer).ProcessPDF(ctx, req.(*PDFRequest))
	}
